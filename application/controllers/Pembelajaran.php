...
class Pembelajaran extends CI_Controller {
    ...
    //Fungsi untuk menampilkan tabel input pada menu analisis pembelajaran 
    //berisikan nilai transformasi dari data pelatihan
    function index() {
    ...
    //Fungsi untuk menampilkan hasil perhitungan inisialisasi bobot dengan metode nguyen widraw
    //berisikan proses perhitungan inisialisasi bobot langkah demi langkah
    //fungsi ini muncul ketika tombol "Analisis Inisialisasi" diklik
    ...
    //Fungsi untuk menampilkan bobot awal pada menu proses pembelajaran
    //fungsi ini berfungsi ketika tombol "Isi Bobot" diklik
    //fungsi ini mengambil bobot standar yang sudah diupload pada menu upload bobot
    function bobot_awal() {
        if (is_null($this->session->userdata("username"))) {
            redirect(base_url() . 'login');
        } else {
            ...
            $data = array('data'=>$mse,'bobot'=>$bobot);
    ...
    //Fungsi untuk menampilkan bobot awal kosong pada menu proses pembelajaran
    //fungsi ini akan dipanggil secara pertama kali untuk menampilkan kolom bobot & bias pada proses pembelajaran
    ...
    //Fungsi untuk pelemparan data yang diperlukan ke proses perhitungan analisis pembelajaran (tapilan result)
    //data yang dilempar akan diolah pada tampilan view result per-iterasi
    function analisis(){
    ...
    //Fungsi untuk menampilkan grafik MSE yang dihasilkan dari hasil pembelajaran
    //fungsi ini mengambil MSE yang sudah disimpan dalam bentuk array_list() kemudian
    //di unserialize() untuk dilempar ke dalam tampilan grafik pada proses pembelajaran
    function mse(){
            $data_pembelajaran = $this->universal_function->getDataArray('result');
            $length = $this->universal_function->count('result','id_result','panjang');
            if($data_pembelajaran){
    ...
    //Fungsi untuk menampilkan perbandingan target vs keluaran JST pada menu proses pembelajaran
    //setelah proses pembelajaran selesai, grafik ini menampilkan perbandingan pada iterasi terakhir
    //atau epoch terakhir dari hasil pembelajaran
    function k_jst(){
