...
class Pembelajaran extends CI_Controller {
    ...
    //Fungsi menampilkan tabel input
        ...
        for($i=1;$i<=$epoch;$i++){
            if($MSE_B== 0 && $MSE_B_S==0 || $MSE_B==$MSE_B_S || $MSE_B<$MSE_B_S && $MSE_B>$mse){
                    ...
                    $data_array = serialize($array);
                        ...
                        $result = $this->universal_function->result($data_array,$iterasi,$d_array,$lr,$mse);
                        if($iterasi>900 && $iterasi<=1800){
                            $data_array1 = serialize($array1);
                            $result = $this->universal_function->result($data_array1,'','','','');
                        }else if($iterasi>1800 && $iterasi<=2700){
                            $data=array(
                        ...
                        }else if($iterasi>2700 && $iterasi<=3600){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                        ...
                        }else if($iterasi>3600 && $iterasi<=4500){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>4500 && $iterasi<=5400){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>5400 && $iterasi<=6300){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>6300 && $iterasi<=7200){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>7200 && $iterasi<=8100){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>8100 && $iterasi<=9000){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>9000 && $iterasi<=9900){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>9900 && $iterasi<=10800){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>10800 && $iterasi<=11700){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>11700 && $iterasi<=12600){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>12600 && $iterasi<=13500){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>13500 && $iterasi<=14400){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>14400 && $iterasi<=15300){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>15300 && $iterasi<=16200){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>16200 && $iterasi<=17100){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>17100 && $iterasi<=18000){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>18000 && $iterasi<=18900){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>18900 && $iterasi<=19800){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>19800 && $iterasi<=20700){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>20700 && $iterasi<=21600){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
                        ...
                        }else if($iterasi>21600 && $iterasi<=22500){
                            $data=array(
                            1=>$data_array1 = serialize($array1),
                            2=>$data_array2 = serialize($array2),
                            3=>$data_array3 = serialize($array3),
