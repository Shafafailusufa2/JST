...
class Pembelajaran extends CI_Controller {
    ...
    //Fungsi menampilkan tabel input pada menu pembelajaran
    function index() {
    ...
    function learning(){
        ...
        $v16 = $this->input->post('v16');
        $v17 = $this->input->post('v17');
        ...
        $v26 = $this->input->post('v26');
        $v27 = $this->input->post('v27');
        ...
        $v36 = $this->input->post('v36');
        $v37 = $this->input->post('v37');
        ...
        $v46 = $this->input->post('v46');
        $v47 = $this->input->post('v47');
        ...
        $v56 = $this->input->post('v56');
        $v57 = $this->input->post('v57');
        ...
        $v06 = $this->input->post('v06');
        $v07 = $this->input->post('v07');
        ...
        $x_1=array($v11,$v12,$v13,$v14,$v15,$v16,$v17);
        $x_2=array($v21,$v22,$v23,$v24,$v25,$v26,$v27);
        $x_3=array($v31,$v32,$v33,$v34,$v35,$v36,$v37);
        $x_4=array($v41,$v42,$v43,$v44,$v45,$v46,$v47);
        $x_5=array($v51,$v52,$v53,$v54,$v55,$v56,$v57);
        $w_1=$w1;
        $w_2=$w2;
        $w_3=$w3;
        $w_4=$w4;
        ...
        $w_6=$w6;
        $w_7=$w7;
        $b_1 = array($v01,$v02,$v03,$v04,$v05,$v06,$v07);
        $b_2 = $w0;
        ...
        for($i=1;$i<=$epoch;$i++){
            ...
            if($MSE_B==0 && $MSE_B_S==0 || $MSE_B==$MSE_B_S || $MSE_B<$MSE_B_S && $MSE_B>$mse){
                    ...
                    foreach ($input as $key => $value) {
                        ...
                        $z_net6 = $v06+($x1*$v16)+($x2*$v26)+($x3*$v36)+($x4*$v46)+($x5*$v56);
                        $z_net7 = $v07+($x1*$v17)+($x2*$v27)+($x3*$v37)+($x4*$v47)+($x5*$v57);
                        ...
                        $z6=1/(1+(pow(2.71828183,-$z_net6)));
                        $z7=1/(1+(pow(2.71828183,-$z_net7)));

                        //Perkalian unit keluaran
                        $y_net = $w0+($z1*$w1)+($z2*$w2)+($z3*$w3)+($z4*$w4)+($z5*$w5)+($z6*$w6)+($z7*$w7);
                        ...
                        //Suku perubahan Bobot unit tersembunyi #6
                        $d_net6 = $dk0*$w6;
                        $dj6 = ($d_net6*$z6)*(1-$z6);
                        //perubahan bias z1(v01)
                        $v06_b = $lr_ib*$dj6;
                        ...
                        //Suku perubahan Bobot unit tersembunyi #7
                        $d_net7 = $dk0*$w7;
                        $dj7 = ($d_net7*$z7)*(1-$z7);
                        //perubahan bias z1(v01)
                        $v07_b = $lr_ib*$dj7;
                        ...
                        $x_1e=array($v11,$v12,$v13,$v14,$v15,$v16,$v17);
                        $x_2e=array($v21,$v22,$v23,$v24,$v25,$v26,$v27);
                        $x_3e=array($v31,$v32,$v33,$v34,$v35,$v36,$v37);
                        $x_4e=array($v41,$v42,$v43,$v44,$v45,$v46,$v47);
                        $x_5e=array($v51,$v52,$v53,$v54,$v55,$v56,$v57);
                        $w_1e=$w1;
                        $w_2e=$w2;
                        $w_3e=$w3;
                        $w_4e=$w4;
                        ...
                        $w_6e=$w6;
                        $w_7e=$w7;
                        $b_1e = array($v01,$v02,$v03,$v04,$v05,$v06,$v07);
                        $b_2e = $w0;
                ...
                if($MSE_B<$mse || $MSE_B>$MSE_B_S || $MSE_B>$mse && $iterasi==$epoch){
                    ...
                    for($x_e=0;$x_e<=6;$x_e++){
                        $insert_bobot = $this->universal_function->insert_hidden($x_1[$x_e],$x_1e[$x_e],$x_2[$x_e],$x_2e[$x_e],$x_3[$x_e],$x_3e[$x_e],$x_4[$x_e],$x_4e[$x_e],$x_5[$x_e],$x_5e[$x_e]);
                        }
                    //penyimpanan bobot awal dan akhir unit keluaran
                    $insert_bobot2 = $this->universal_function->insert_output($w_1,$w_1e,$w_2,$w_2e,$w_3,$w_3e,$w_4,$w_4e,$w_5,$w_5e,$w_6,$w_6e,$w_7,$w_7e);
    ...
    function inisial(){
        ...
        $v6 = sqrt(pow($v16,2)+pow($v26,2)+pow($v36,2)+pow($v46,2)+pow($v56,2));
        $v7 = sqrt(pow($v17,2)+pow($v27,2)+pow($v37,2)+pow($v47,2)+pow($v57,2));
