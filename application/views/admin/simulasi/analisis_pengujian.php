<!-- Pemanggil Javascript untuk menu analisis data pengujian -->
<?php include('proccess_simulasi.php'); ?>

<!-- Header dan title dari menu analisis data pengujian -->
<div class="header">
...
data yang dicek adalah data keluaran JST, data dari tabel result, data asli dari tb_pengujian
data dilempar dari localhost/JST/peramalan/simpenganalis
 -->
...
<script type="text/javascript">
     ...
     function detail(){
        ...
        ajax.open("POST", "<?php echo base_url() . 'peramalan/analisis_pengujian/'; ?>", false);
        ajax.send(formdata);
     ...
     $(function () {
            ...
            $(document).ready(function() {
                ...
                //localhost/JST/peramalan/analispeng
                $.getJSON("<?php base_url() ?>peramalan/analispeng/", function(json) {
