<script type="text/javascript">
  //Fungsi untuk menampilkan tombol detail setelah proses perhitungan propagasi maju data pelatihan yang dipilih selesai
	$('.detail').show();
</script>
<!--
...
data dilempar dari localhost/JST/peramalan/analisis_pelatihan
-->
<?  
		...
		<? 
          ...
          <?
            if(round($normalisasi_target)>round($normalisasi_jst)){
             ...
             $Akurasi = number_format((round($normalisasi_target)/round($normalisasi_jst))*100,2);
            }else{
             $Akurasi = (round($normalisasi_target)/round($normalisasi_jst))*100;
            }  ?>
          </tr> 
