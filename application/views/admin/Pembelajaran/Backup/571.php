            ...
            <div id="i_1">
                  ...
                  <input type="text" class="form-control" id="v16" placeholder="v16" value="<? echo $v16 ?>">
                  <input type="text" class="form-control" id="v17" placeholder="v17" value="<? echo $v17 ?>">
            </div>
            <div id="i_2">
                  <label>x2</label>
                  ...
                  <input type="text" class="form-control" id="v26" placeholder="v26" value="<? echo $v26 ?>">
                  <input type="text" class="form-control" id="v27" placeholder="v27" value="<? echo $v27 ?>">
            </div>
            <div id="i_3">
            <label>x3</label>
                  ...
                  <input type="text" class="form-control" id="v36" placeholder="v36" value="<? echo $v36 ?>">
                  <input type="text" class="form-control" id="v37" placeholder="v37" value="<? echo $v37 ?>">
            </div>
            <div id="i_4">
            <label>x4</label>
                  ...
                  <input type="text" class="form-control" id="v46" placeholder="v46" value="<? echo $v46 ?>">
                  <input type="text" class="form-control" id="v47" placeholder="v47" value="<? echo $v47 ?>">
            </div>
            <div id="i_5">
            <label>x5</label>
                  ...
                  <input type="text" class="form-control" id="v56" placeholder="v56" value="<? echo $v56 ?>">
                  <input type="text" class="form-control" id="v57" placeholder="v57" value="<? echo $v57 ?>">
            </div>
            </div>
            ...
            <div id="i_6">
                  ...
                  <input type="text" class="form-control" id="v06" placeholder="v06" value="<? echo $v06 ?>">
                  <input type="text" class="form-control" id="v07" placeholder="v07" value="<? echo $v07 ?>">
            </div>
            <div id="i_7">
